...
function BinarySearchTree() {
  ...
  BinarySearchTree.prototype.insert = function(value) {
    ...
    function insertNode(currentNode, newNode){
      // checks leftChild of currentNode
      ...
      // checks rightChild of currentNode
      else{
    ...
    // if BST is empty, simply assign the first node to its root
    if (this.root === null){
      this.root = node;
      this.size++;
    // otherwise, lets recursively traverse through the BST
    } else{
  ...
  BinarySearchTree.prototype.search = function(value) {
    var node = new Node(value);
    var result
    function searchNode(currentNode, wantedNode){
      if (currentNode.value === wantedNode.value){
        result = true
      } else if (currentNode.value > wantedNode.value && currentNode.leftChild){
          searchNode(currentNode.leftChild, wantedNode)
      } else if (currentNode.value < wantedNode.value && currentNode.rightChild){
           searchNode(currentNode.rightChild, wantedNode)
      } else{
        result = false
      }

    }
    searchNode(this.root, node)
    return result
  };
